// ================================= ============================================ //
// Intermediary mappings for Crab Game v1.362 (obfuscated IL2CPP assembly).       //
// These global using aliases map friendly names to the obfuscated IL2CPP types.  //
// Sourced from the CrabGameMoreSettings Intermediary.cs — only the subset needed  //
// by TitaniumCrab is included here.                                              //
// ================================= ============================================ //
...
global using CurrentSettings = ObjectPublicObInUIInStInUIInInUnique;
...
global using SaveManager = MonoBehaviourPublicObInVoAwVoVoVoVoVoVoUnique;
